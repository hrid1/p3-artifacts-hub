...
const Register = () => {
  ...
  return (
    <div className="flex items-center justify-center  min-h-[calc(100vh-80px)]">
      <div className="w-full border max-w-md p-6 bg-amber-50 rounded-lg shadow-xl">
        ...
        <form onSubmit={handleRegister} className="mt-4">
          ...
          <button
            type="submit"
            className="w-full px-4 py-2 mt-6 text-white bg-gradient-to-r from-amber-400 to-amber-600 rounded-lg  font-semibold"
          >
            Register
          </button>
        </form>
